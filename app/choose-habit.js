      ...
      >
        ...
        <View style={styles.heroTop}>
          <View style={styles.heroIcon}>
            <Feather name={selectedCategory.icon} size={34} color="#FFFFFF" />
          </View>
        ...
        <View style={styles.heroFooter}>
          <Feather name="circle" size={15} color="rgba(255,255,255,0.85)" />
          <Text style={styles.heroHint}>Small actions shape your orbit.</Text>
        </View>
      </LinearGradient>
        ...
        {habitCategories.map((category) => {
          ...
          return (
            ...
            >
              ...
              >
                <Feather name={category.icon} size={22} color="#FFFFFF" />
